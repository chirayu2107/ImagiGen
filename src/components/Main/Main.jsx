  ...
  return (
    <div className="main">
      <div className="nav">
        ...
        <p>ImagiGen</p>
        <img src="https://res.cloudinary.com/dkoiyuyhj/image/upload/v1721746045/in3bi5ob9wffejnlk5yg.png" alt="" />
      </div>
      <div className="main-container">
        ...
        <div className="main-bottom">
          ...
          <p className="bottom-info">
            ImagiGen may display inaccurate info, including about people, so
            double-check its responses. Your Privacy and ImagiGen Apps
          </p>
        </div>
      </div>
    </div>
